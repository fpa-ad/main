...
//Old function to get random initial position; no longer used
double random_pos();

//Old function to get random initial velocity; no longer used
double random_speed();

//Function to get a Newton's method aproximation of the solution to f(x)=a
...
//Function to get a Newton's method aproximation of the solution to \int_{-\infty}^{x} f(t) dt = a (parameters optimized for position initialization)
...
//Function to get a Newton's method aproximation of the solution to \int_{-\infty}^{x} f(t) dt = a (parameters optimized for low velocity initialization)
//@param f function whose integral to apply Newton's method to
//@param a constant on the RHS of the equation f(x) = a
//@param x0 initial value for x
//@param iterations number of iterations of Newton's method
...
//Function to get a Newton's method aproximation of the solution to \int_{-\infty}^{x} f(t) dt = a (parameters optimized for high velocity initialization)
//@param f function whose integral to apply Newton's method to
//@param a constant on the RHS of the equation f(x) = a
//@param x0 initial value for x
//@param iterations number of iterations of Newton's method
